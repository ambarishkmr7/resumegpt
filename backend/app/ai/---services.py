...
def generate_sample_resume(job_title: str, years_experience: int, name: str) -> dict:
    ...
    skills = ROLE_SKILLS.get(title_lower, ROLE_SKILLS.get("software engineer"))
    ...
    content = {
        ...
        "summary": f"Results-driven {job_title} with {years_experience}+ years of experience. "
                   ...
                   f"Passionate about building scalable systems and continuous learning.",
        "experience": experiences,
        "education": [{"degree": "Bachelor's in Computer Science", "school": "University", "location": "", "start": str(2025 - years_experience - 4), "end": str(2025 - years_experience), "details": ""}],
        "skills": skills,
        "skill_ratings": [{"name": s, "rating": 5 if i < 3 else 4 if i < 6 else 3} for i, s in enumerate(skills[:8])],
        "core_competencies": ["Problem Solving", "Team Collaboration", "Communication", "Agile Methodology"],
        "projects": [],
        "certifications": [],
        "languages": ["English"],
        "accomplishments": [],
