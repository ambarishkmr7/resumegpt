    ...
    <div className="career-chat">
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          .chat-content-padding { padding: 50px 10px 10px !important; }
          .chat-welcome { padding: 20px 10px; }
          .chat-welcome h1 { font-size: 20px; }
          .chat-welcome p  { font-size: 14px; margin-bottom: 20px; }
          .suggestions { gap: 8px; }
          .suggestions button { padding: 8px 12px; font-size: 12px; }
          .message { margin-bottom: 16px; }
          .message-content { max-width: 92%; padding: 10px 14px; font-size: 14px; }
          .message-content .markdown-body { font-size: 14px; }
          ...
          .chat-input-area textarea { padding: 10px 12px; font-size: 14px; min-height: 44px; }
          .send-btn { height: 44px; padding: 0 16px; font-size: 13px; }
          .skeleton-bubble { max-width: 80%; padding: 10px 14px; }
        }
        @media (max-width: 480px) {
          .chat-welcome .welcome-icon { font-size: 36px; }
          .chat-welcome h1 { font-size: 18px; }
          .message-content { max-width: 95%; }
          .skeleton-message.user .skeleton-bubble { min-width: 80px; }
          .skeleton-message.assistant .skeleton-bubble { min-width: 120px; }
        }
      `}</style>
    </div>
  );
