...
export default function CareerPage() {
  ...
  return (
    <div className="career-fullscreen">
      ...
      {/* Mobile overlay — tap anywhere outside sidebar to close it */}
      {sidebarOpen && (
        <div className="career-sidebar-overlay" onClick={() => setSidebarOpen(false)} />
      )}
      ...
      <style>{`
        ...
        .career-sidebar-overlay {
          ...
          z-index: 15;
          animation: careerFadeIn 0.15s ease;
        }
        ...
        @media (max-width: 768px) {
          ...
          .new-chat-btn { padding: 8px; font-size: 13px; }
          .conversation-item { padding: 10px; }
          .conv-title { font-size: 12px; }
        }
