    ...
    <>
      ...
      <div className="container" style={{ maxWidth: 820 }}>
        ...
        <Section title="Personal Details" icon="👤">
          <div className="profile-photo-row" style={{ display: "flex", alignItems: "flex-end", gap: 20, marginBottom: 20 }}>
      ...
      <style>{`
        ...
        @media (max-width: 640px) {
          ...
          .profile-completion svg { width: 56px; height: 56px; }
          .profile-section-header { padding: 12px 14px; font-size: 15px; }
          .profile-section-body { padding: 0 14px 14px; }
          .profile-photo-row { flex-direction: column; gap: 14px; }
          .profile-photo-row > div:first-child { align-self: center; }
          .profile-photo-row > div:last-child { width: 100%; }
          .profile-photo-row .field { margin-bottom: 10px; }
          .profile-save-row { flex-direction: column; align-items: stretch; }
          .profile-save-row .btn { width: 100%; }
          .profile-section .field:has(input[type="checkbox"]) { padding-top: 0 !important; }
        }
        @media (max-width: 480px) {
          .profile-header h2 { font-size: 20px; }
          .profile-header p { font-size: 13px; }
          .profile-section-body { padding: 0 10px 12px; }
          .profile-photo-row .field { margin-bottom: 8px; }
        }
      `}</style>
    </>
  );
